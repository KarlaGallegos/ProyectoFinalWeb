from flask import Flask, render_template, request, url_for, flash, redirect, send_file,session, make_response,send_from_directory, jsonify
...
class ConfigManager:
    ...
    def init_app(self, app):
        ...
        app.config['MYSQL_PASSWORD'] = '041002'
        app.config['MYSQL_DB'] = 'PARNETDB'
...
def eliminar_producto(id_producto):
    ...
    return redirect(url_for('productos_privado'))  # Redirecciona a la página de productos
